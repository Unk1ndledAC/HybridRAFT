...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='HybridRAFT')
    ...
    parser.add_argument('--model', type=str, default='HybridRAFT',
                        help='model name, options: [HybridRAFT]')
    ...
    # RAFT specific
    parser.add_argument('--n_period', type=int, default=3, help='number of periods for retrieval')
    parser.add_argument('--topm', type=int, default=20, help='top k retrieval')
    ...
    parser.add_argument('--use_dtw', type=bool, default=False, 
                        help='whether to use dtw metric for evaluation')
    ...
    parser.add_argument('--randompermutation', type=bool, default=False, help="Random Length Permutation preset augmentation")
    ...
    parser.add_argument('--dtwwarp', type=bool, default=False, help="Time warp preset augmentation")
    parser.add_argument('--shapedtwwarp', type=bool, default=False, help="ShapeDTW warp preset augmentation")
    parser.add_argument('--wdba', type=bool, default=False, help="Weighted DBA preset augmentation")
    parser.add_argument('--discdtw', type=bool, default=False, help="Discrimnative DTW warp preset augmentation")
    parser.add_argument('--discsdtw', type=bool, default=False, help="Discrimnative ShapeDTW warp preset augmentation")
